        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div ref={heroRef} className="text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-none mb-8">
              Let&apos;s Work{" "}
              <span className="font-normal text-red-500">Together</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
            <div>
              <div className="mb-8">
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-light mt-4 mb-6">
                  Send me a message
                </h2>
                <div
                  className={`w-12 h-px 
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <Input
                      ...
                      className={`h-12 
                          ...
                          dark:bg-gray-900/50 dark:border-gray-700 dark:text-white dark:placeholder-gray-500 dark:focus:border-red-500 dark:focus:ring-red-500
                ...
                <Button
                  ...
                  className={`w-full h-12 font-medium transition-all duration-200 disabled:opacity-50 
                        dark:bg-red-600 dark:hover:bg-red-700 dark:text-white bg-blue-600 hover:bg-blue-700 text-white
                  `}
                >
                ...
                <div className="flex space-x-6">
                  <a
                    ...
                    className={`w-10 h-10 
                        ...
                        dark:bg-gray-800 dark:hover:bg-red-600
