...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  const animateColor = useCallback((opening: boolean) => {
    ...
    const targetColor = opening ? "#fff" : "#fff";
  ...
  React.useEffect(() => {
    if (toggleBtnRef.current) {
      const targetColor = openRef.current ? "#fff" : "#fff";
    ...
    >
      ...
      >
        <div className="sm-logo" aria-label="Logo">
          <img alt="Logo" src={"/logo.png"} className="sm-logo-img" />
        </div>
        <button
          ref={toggleBtnRef}
          className="sm-toggle"
        ...
        >
          <span
            ref={textWrapRef}
            className="sm-toggle-textWrap relative"
            aria-hidden="true"
          >
